 ...
 */
            window.Sticksy = function() {
                ...
                function Sticksy(target, options) {
                    ...
                    if (typeof target !== "string" && !(target instanceof Element)) throw new Error("Expected a string or element, but got: " + Object.prototype.toString.call(target));
                ...
                Sticksy.prototype.hardRefresh = function() {
                    ...
                    this._applyState(this.state);
                    this._startListen();
                    if (typeof this.onStateChanged === "function" && oldState !== this.state) this.onStateChanged(this.state);
                };
                ...
                Sticksy.initializeAll = function(target, options, ignoreNothingFound) {
                    ...
                    var elements = [];
                    if (target instanceof Element) elements = [ target ]; else if (typeof target.length !== "undefined" && target.length > 0 && target[0] instanceof Element) elements = typeof target.get === "function" ? target.get() : target; else if (typeof target === "string") elements = document.querySelectorAll(target) || [];
                    var parents = [];
                    var stickyElements = [];
                    elements.forEach((function(el) {
